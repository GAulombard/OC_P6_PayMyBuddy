INSERT INTO user (first_name,last_name,email,password,phone,address,zip,city,user_role)
    VALUES ("Geoffrey","Aulombard","g.aulomb@jetmail.fr","123456789",0674558612,"2 rue de ville",45000,"Orlyans","ADMIN");
INSERT INTO user (first_name,last_name,email,password,phone,address,zip,city)
    VALUES ("Jean","Bombeurre","j.bombeurre@jetmail.fr","123456789",0679458612,"4 rue des snacks",75000,"Poris");
INSERT INTO user (first_name,last_name,email,password,phone,address,zip,city)
    VALUES ("Laura","Jamais","laura.jamais@jetmail.fr","123456789",0679458612,"12 rue de l'espoire",23000,"Limouge");
INSERT INTO user (first_name,last_name,email,password,phone,address,zip,city)
    VALUES ("Mark","Nofler","m.nofler@jetmail.fr","123456789",0679458612,"8 rue des musicos",75000,"Poris");
INSERT INTO user (first_name,last_name,email,password,phone,address,zip,city)
    VALUES ("Long","Tram","tram.long@takatoukite.fr","123456789",0679458612,"16 bis avenue du soleil levant",75000,"Poris");
INSERT INTO user (first_name,last_name,email,password,phone,address,zip,city)
    VALUES ("Zinezine","Zizane","z.z@jetmail.fr","123456789",0679458612,"15 rue de la balle",13000,"Marsèye");
INSERT INTO user (first_name,last_name,email,password,phone,address,zip,city)
    VALUES ("Ana","Pu","ana.pu@yahoo.fr","123456789",0679458612,"126 avenue de rien",75000,"Poris");
