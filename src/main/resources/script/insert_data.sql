...
INSERT INTO user (first_name,last_name,email,password,phone,address,zip,city)
    VALUE ("Jean","Bombeurre","j.bombeurre@jetmail.fr","123456789",NULL,"4 rue des snacks",75000,"Poris");
INSERT INTO user (first_name,last_name,email,password,phone,address,zip,city)
    VALUE ("Laura","Jamais","laura.jamais@jetmail.fr","123456789",NULL,"12 rue de l'espoire",23000,"Limouge");
INSERT INTO user (first_name,last_name,email,password,phone,address,zip,city)
    VALUE ("Mark","Nofler","m.nofler@jetmail.fr","123456789",NULL,"8 rue des musicos",75000,"Poris");
INSERT INTO user (first_name,last_name,email,password,phone,address,zip,city)
    VALUE ("Long","Tram","tram.long@takatoukite.fr","123456789",NULL,"16 bis avenue du soleil levant",75000,"Poris");
INSERT INTO user (first_name,last_name,email,password,phone,address,zip,city)
    VALUE ("Zinezine","Zizane","z.z@jetmail.fr","123456789",NULL,"15 rue de la balle",13000,"Marsèye");
INSERT INTO user (first_name,last_name,email,password,phone,address,zip,city)
    VALUE ("Ana","Pu","ana.pu@yahoo.fr","123456789",NULL,"126 avenue de rien",75000,"Poris");
